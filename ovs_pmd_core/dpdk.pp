...
#
# [*host_core_list*]
#   (required) The list of host cores to be used by the DPDK Poll Mode Driver
...
#
# [*pmd_core_list*]
#   (required) The list of cores to be used by the OVS Agent
...
class vswitch::dpdk (
  ...
  if $host_core_list {
    ...
    fail('either host core list or core list must be set for ovs agent when DPDK is enabled')
  }
